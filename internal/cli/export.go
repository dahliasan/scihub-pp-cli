...
large datasets as it has no memory pressure.`,
  ...
  scihub-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  scihub-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  scihub-pp-cli export <resource> --format jsonl | jq '.id'`,
