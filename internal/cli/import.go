...
but do not stop the import.`,
  ...
  scihub-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  scihub-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | scihub-pp-cli import <resource> --input -`,
