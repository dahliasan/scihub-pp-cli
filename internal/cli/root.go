...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "scihub-pp-cli",
		Short: `Scihub CLI — Agent-native DOI to PDF fetcher with mirror discovery, probe, and resumable batch jobs.`,
		Long: `Scihub CLI — Agent-native DOI to PDF fetcher with mirror discovery, probe, and resumable batch jobs.
...
Health check: run 'scihub-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("scihub-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'scihub-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDoiPromotedCmd(flags))
	rootCmd.AddCommand(newMirrorsPromotedCmd(flags))
	rootCmd.AddCommand(newStoragePromotedCmd(flags))
	rootCmd.AddCommand(newFetchCmd(flags))
	rootCmd.AddCommand(newProbeCmd(flags))
